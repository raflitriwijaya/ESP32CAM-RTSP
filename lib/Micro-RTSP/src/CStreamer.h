...
private:
    ...
    // FIXME(VENDOR): m_width/m_height moved from private to protected
    // so OV2640Streamer can set them after explicit run(). These files
    // should be vendored to lib/Micro-RTSP/ in a later refactor step.
protected:
